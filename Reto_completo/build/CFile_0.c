...
extern "C" __IEC_BOOL_t CONFIG0__SERVO1_ON;
#define Servo1_ON CONFIG0__SERVO1_ON.value
extern "C" __IEC_BOOL_t CONFIG0__SERVO2_ON;
#define Servo2_ON CONFIG0__SERVO2_ON.value
extern "C" __IEC_BOOL_t CONFIG0__SERVO3_ON;
#define Servo3_ON CONFIG0__SERVO3_ON.value
extern "C" __IEC_BOOL_t CONFIG0__SERVO4_ON;
#define Servo4_ON CONFIG0__SERVO4_ON.value
